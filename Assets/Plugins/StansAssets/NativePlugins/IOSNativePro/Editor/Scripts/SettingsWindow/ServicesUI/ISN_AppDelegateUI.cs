...
namespace SA.iOS
{
    class ISN_AppDelegateUI : ISN_ServiceSettingsUI
    {
        ...
        public override string Description => "A set of methods that are called in response to important events in the lifetime of your app.";

        protected override Texture2D Icon => SA_EditorAssets.GetTextureAtPath(ISN_Skin.IconsPath + "AppDelegate_icon.png");

        public override SA_iAPIResolver Resolver => ISN_Preprocessor.GetResolver<ISN_AppDelegateResolver>();
