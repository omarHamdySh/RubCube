...
namespace SA.iOS
{
    class ISN_ContactsUI : ISN_ServiceSettingsUI
    {
        ...
        protected override Texture2D Icon => SA_EditorAssets.GetTextureAtPath(ISN_Skin.IconsPath + "Contacts_icon.png");

        public override SA_iAPIResolver Resolver => ISN_Preprocessor.GetResolver<ISN_ContactsResolver>();
