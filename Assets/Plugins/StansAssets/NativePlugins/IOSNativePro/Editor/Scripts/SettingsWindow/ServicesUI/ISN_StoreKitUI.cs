...
namespace SA.iOS
{
    class ISN_StoreKitUI : ISN_ServiceSettingsUI
    {
        ...
        public override string Description => "Support in-app purchases and interactions with the App Store.";

        protected override Texture2D Icon => SA_EditorAssets.GetTextureAtPath(ISN_Skin.IconsPath + "StoreKit_icon.png");

        public override SA_iAPIResolver Resolver => ISN_Preprocessor.GetResolver<ISN_StoreKitResolver>();
