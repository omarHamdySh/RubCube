...
namespace SA.iOS.XCode
{
    public class ISD_GeneralWindowTab : SA_GUILayoutElement
    {
        ...
        SA_PluginActiveTextLink m_entitlementsLink;
        ...
        public override void OnGUI()
        {
            ...
            var buildSettings_icon = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "BuildSettings.png");
            using (new SA_WindowBlockWithIndent(new GUIContent("Build Properties", buildSettings_icon)))
            {
                foreach (var property in ISD_Settings.Instance.BuildProperties) property.Value = SA_EditorGUILayout.StringValuePopup(property.Name, property.Value, property.Options);
        ...
        void Settings()
        {
            var settings_icon = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "isdSettings.png");
        ...
        void Entitlements()
        {
            var entitlements = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "entitlements.png");
        ...
        {
            var folder = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "folder.png");
        ...
        {
            var plistVariables_icon = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "plistVariables.png");
        ...
        {
            var linkerFlags = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "linkerFlags.png");
        ...
        public void Languages()
        {
            ...
            var languages_icon = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "languages.png");
        ...
        {
            var framework_icon = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "frameworks.png");
            using (new SA_WindowBlockWithIndent(new GUIContent("Frameworks", framework_icon)))
            {
                ...
                if (IsDefFrameworksOpen)
                {
                    ...
                    using (new SA_GuiBeginHorizontal())
                    {
                        ...
                        {
                            foreach (var framework in ISD_FrameworkHandler.DefaultFrameworks) SA_EditorGUILayout.SelectableLabel(framework.Type.ToString() + ".framework", "");
                        }
                    }
        ...
        {
            var libraries_icon = SA_EditorAssets.GetTextureAtPath(ISD_Skin.ICONS_PATH + "libraries.png");
