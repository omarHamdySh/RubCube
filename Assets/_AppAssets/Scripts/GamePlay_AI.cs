...
public class GamePlay_AI : MonoBehaviour
{
    ...
    public void setRotationDoesntMatched()
    {
        Founded = true;
    }
    ...
    public void setCurrentUpFacePopulationFlagTrue()
    {
        faceIsPopulated = true;
    }

    public void setCurrentUpFacePopulationFlagFalse()
    {
        faceIsPopulated = false;
    }
}